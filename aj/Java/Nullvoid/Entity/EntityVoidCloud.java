...
public class EntityVoidCloud extends EntityTameable {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (this.isTamed())
        {
            if (itemstack != null)
            {
                if (itemstack.getItem() instanceof ItemIngotNull)
                {

                    if (this.dataWatcher.getWatchableObjectFloat(18) < 75.0F)
                    {
        ...
        else if (itemstack != null && itemstack.getItem() instanceof ItemIngotVoid)
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
