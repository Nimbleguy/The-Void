...
public class MovingSoundPlayer extends MovingSound {
	 private final EntityPlayer field_147670_k;
	    private float field_147669_l = 0.0F;
	    private static final String __OBFID = "CL_00001118";

	    public MovingSoundPlayer(EntityPlayer p_i45105_1_)
	    {
	        super(new ResourceLocation("nullvoid:sounds.ambient.piertonowhere"));
	    ...
	    public void update()
	    {
	        if (this.field_147670_k.dimension != VoidMod.NullVoidDimID)
	        {
