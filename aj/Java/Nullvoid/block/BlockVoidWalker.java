...
public class BlockVoidWalker extends BlockContainer {
	...
	public void onBlockPreDestroy(World w, int x, int y, int z, int oldmeta) {
		...
		TileEntityVoidWalker te = (TileEntityVoidWalker) w.getTileEntity(x, y,
				z);
		if (te.getStackInSlot(0) != null) {
			w.spawnEntityInWorld(new EntityItem(w, x, y, z, te.getStackInSlot(0)));
		}
		if (te.getStackInSlot(1) != null) {
			w.spawnEntityInWorld(new EntityItem(w, x, y, z, te.getStackInSlot(1)));
		}
		if (te.getStackInSlot(2) != null) {
			w.spawnEntityInWorld(new EntityItem(w, x, y, z, te.getStackInSlot(2)));
		}
		if (te.getStackInSlot(3) != null) {
			w.spawnEntityInWorld(new EntityItem(w, x, y, z, te.getStackInSlot(3)));
		}
	}
}
